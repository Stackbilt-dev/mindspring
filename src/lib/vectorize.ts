import type { Env, ConversationMetadata, ConversationRecord, SearchResult } from './types'
...
export class VectorStore {
  ...
  async list(
    ...
    return {
      conversations: conversations.filter(Boolean) as ConversationRecord[],
